...
export async function POST() {
  try {
    ...
    // 1. Ensure database tables and new columns exist in target PostgreSQL database
    try {
      ...
      console.warn("Seed SQL table creation/alter warning:", sqlErr);
    }
    ...
    try {
      ...
      console.warn("Seed products warning:", prodErr);
    }
    ...
    try {
      ...
      console.warn("Seed coupons warning:", couponErr);
    }
    ...
    try {
      ...
      console.warn("Seed reviews warning:", revErr);
    }
