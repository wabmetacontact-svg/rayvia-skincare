      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:px-8 lg:py-24">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -bottom-6 -left-2 w-56 rounded-2xl border border-ink/10 bg-white/90 p-4 shadow-soft backdrop-blur-lg sm:-left-6"
          >
          ...
          <motion.div
            ...
            className="absolute -right-2 top-8 rounded-2xl border border-ink/10 bg-white/90 p-4 shadow-soft backdrop-blur-lg sm:-right-6"
          >
            <div className="flex items-center gap-1">
              {[1, 2, 3, 4, 5].map((i) => (
