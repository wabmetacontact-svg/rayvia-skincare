...
export const FOOTER_LINKS = {
  Shop: [
    ...
    { label: "De-Tan Scrub", href: "/products/glow-renew-de-tan-scrub" },
    { label: "De-Tan Face Pack", href: "/products/radiance-de-tan-face-pack" },
    { label: "De-Tan Serum", href: "/products/even-tone-de-tan-serum" },
  ],
  Company: [
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Most customers notice visibly brighter, de-tanned skin after the first use. For long-term even tone, consistent use for 4-6 weeks delivers the best results.",
  },
  {
  ...
  },
  {
    ...
    a: "We offer free shipping on orders above ₹499. Standard delivery takes 3-5 business days across India. A flat shipping fee of ₹49 applies to orders below ₹499.",
  },
  {
  ...
  },
  {
    ...
    a: "Once your order ships, you'll receive a tracking number via SMS and email. You can also track your order anytime from the Track Order page using your Order ID and phone number.",
  },
  {
    q: "What payment methods are accepted?",
    a: "We accept UPI, all major credit/debit cards, net banking and Cash on Delivery (COD).",
  },
];
